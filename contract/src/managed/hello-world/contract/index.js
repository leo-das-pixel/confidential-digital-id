...
export class Contract {
  ...
  constructor(...args_0) {
      ...
      verifyCredential: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyCredential',
                                     ...
                                     'hello-world.compact line 12 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(credentialSecret_0),
    ...
    this.impureCircuits = { verifyCredential: this.circuits.verifyCredential };
  ...
  _verifyCredential_0(context, partialProofData, credentialSecret_0) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
