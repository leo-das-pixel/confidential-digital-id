/**
 * End-to-end smoke check for confidential-digital-id.
 *
...
import { resolveNetwork, getOrCreateSeed, getDeployment } from '../cipherid-cli/src/network';
import { createWallet, persistWalletState } from '../cipherid-cli/src/wallet';
